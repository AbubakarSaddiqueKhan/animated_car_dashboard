...
class _DashboardState extends State<Dashboard>
  ...
  late Animation<double> opacityAndScaleAnimation;
  late Animation<double> carSpeedAnimation;
  late Animation<double> outerBorderOpacityAnimation;
  ...
  void initState() {
    ...
    outerBorderOpacityAnimation = Tween<double>(begin: 0, end: 1).animate(
        CurvedAnimation(
            parent: _animationController, curve: const Interval(0, 0.15)));

    opacityAnimation = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
        parent: _animationController, curve: const Interval(0.25, 0.35)));

    opacityAndScaleAnimation = Tween<double>(begin: 0, end: 1).animate(
        CurvedAnimation(
            parent: _animationController, curve: const Interval(0.4, 0.6)));

    carSpeedAnimation = Tween<double>(begin: 0, end: 255).animate(
        CurvedAnimation(
            parent: _animationController, curve: const Interval(0.55, 1)));
  }
  ...
  void startDashBoardAnimation() async {
                ...
                children: [
                  Container(
                    ...
                    child: AspectRatio(
                      aspectRatio: 2.59,
                      child: Opacity(
                        opacity: outerBorderOpacityAnimation.value,
                        child: AnimatedScale(
                          duration: ((_animationController.duration!) * 0.01),
                          scale: outerBorderOpacityAnimation.value,
                          child: LayoutBuilder(
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            const Spacer(),
                                            Opacity(
                                              opacity: opacityAndScaleAnimation
                                                  .value,
                                              child: AnimatedScale(
                                                duration: ((_animationController
                                                        .duration!) *
                                                    0.01),
                                                scale: opacityAndScaleAnimation
                                                    .value,
                                                child: Row(
                                                  mainAxisAlignment:
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: AnimatedBuilder(
                                                        ...
                                                        builder:
                                                            (context, child) =>
                                                                Text(
                                                          "${carSpeedAnimation.value.toInt() * 4} km/H",
                                                          style: Theme.of(
                                                                  context)
                                                              .textTheme
                                                              .titleMedium!
